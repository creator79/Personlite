...
export const GoogleGeminiEffect = ({
  ...
  return (
    <div className={cn("sticky top-10 bg-white dark:bg-black", className)}>
      <h1 className="text-6xl font-bold text-black dark:text-white flex justify-center items-center overflow-hidden mb-10 mt-[-2rem]">
        ABOUT ME🥯
      </h1>

      <div className="flex mr-[25rem] ">
  ...
  <div className="w-full">
    ...
    <div className="flex gap-2 my-2  borderColor ">
      ...
      {/* <div className=" w-full h-10 -top-90 md:-top-40  flex items-center justify-center bg-red-transparent absolute "></div> */}
      <svg
        width="1440"
        height="890"
        viewBox="0 0 1440 890"
        xmlns="http://www.w3.org/2000/svg"
        className=" absolute -top-60  md:-top-40 w-full mt-40 "
      >
        <motion.path
